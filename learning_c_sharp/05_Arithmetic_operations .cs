...
namespace ArithmeticOperation
{
    class Program
    {
        public static void Main()
        {
            ...
            // Здесь мы имеем дело с тремя операциями: дикремент, вычитание и умножение
            // Сначала выполняется декремент переменной, затем умножение, а потом вычитание
            int d = (c--) - (b * a);

            // С помощью скобок мы можем изменить порядок операция, пример:
            int a = 3;
            int b = 5;
            int c = 40;
